...
-- Q3
select nameFull
from players as PL, receiver as R, passer as PR
where R.playerId = PL.playerId
    and PR.passPosition = "WR"
    and PR.passComp = 1;

-- runners with at least 7 TDs
-- Q4
select P.fullName as Players
from players as P, rusher as RS
where P.playerID = RS.playerID
    and RS.playerID = R.playerID
    and P.position = "RB"
group by P.playerID
having RS.totalTDs >= 7;
...
-- Q11
select fullName
from interceptions as I, sacks as S
